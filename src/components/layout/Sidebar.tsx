...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className="relative z-50 h-fit w-20 pointer-events-none">
            ...
            <div 
                className="flex flex-col items-center py-4 gap-4 w-full h-fit max-h-[90vh] bg-[#1a1612] rounded-3xl shadow-2xl border border-[#3f362b] overflow-y-auto overflow-x-hidden custom-scrollbar pointer-events-auto"
                style={{ 
